...
- Conhecimentos aplicados em projetos de alta volumetria de dados, desde integrações simples até arquiteturas escaláveis em nuvem.  
- Experiência prática em Microsoft Azure, Amazon Web Services (AWS) e Apache Spark/PySpark para orquestração, processamento distribuído e governança de dados.  
