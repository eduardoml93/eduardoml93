...
- 🌱 &nbsp; Experiência com linguagem Python, SQL e PySpark para Análise, Engenharia e ETL de Dados. Habilidades como pensamento analítico para resolução de problemas de negócio. Experiência em Big Data, Small Data e computação em nuvem utilizando a plataforma da Microsoft Azure. Processos de ETL/ELT com Jupyter Notebook, Databricks, Looker Studio e Azure Data Factory. Conhecimentos em modelagem de dados para construção de DW, Star Schema, Floco de Neve e arquitetura Medalhão. Conhecimento de ferramentas de visualização de dados como Power BI e Looker Studio para construção de dashboards.
